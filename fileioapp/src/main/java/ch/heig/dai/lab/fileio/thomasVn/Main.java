...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 2 || !new File(args[0]).isDirectory()) {
            System.out.println("You need to provide 2 arguments in command line: an existing folder and the number of words per line.");
            System.exit(1);
        }
        ...
        while (true) {
            try {
                ...
                // Check if the file was written successfully or not
                if (success) {
