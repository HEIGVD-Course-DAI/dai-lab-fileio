...
import ch.heig.dai.lab.fileio._9r55hs.*;

public class Main {
    private static final String newName = "Dylan Stegmüller";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                fileReaderWriter.writeFile(processedFile, content, StandardCharsets.UTF_8);
