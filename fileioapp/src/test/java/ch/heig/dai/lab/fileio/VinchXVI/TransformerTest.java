...
import ch.heig.dai.lab.fileio.VinchXVI.Transformer;
...
public class TransformerTest {
    ...
    private final ch.heig.dai.lab.fileio.VinchXVI.Transformer transformer = new Transformer(newName, numWordsPerLine);
